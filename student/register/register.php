                ...
                if (filter_var($email, FILTER_VALIDATE_EMAIL)){
                    if(!empty($school) && !empty($major) && !empty($year) && !empty($newskills) && !empty($file_name)){
                            if ($password == $cpassword) {
                                $sql = "INSERT INTO student (username, email, password, school, major, year, skills, job, resume)
                                    VALUES ('$username','$email','$password','$school','$major','$year','$newskills','$job','$file_name')";
                                $result = mysqli_query($conn, $sql);
                                if ($result) {
                                    echo '<script>
