...
<body>
  ...
  <section class="home-section">
    ...
    <div class="home-content">
      <div class="display">
        <div class="info">
          <h4>Pending Students / Graduates</h4>
        </div>
        <div class="info1">
          <a href="../controller/student.php?export=excel" class="btn btn-info m-1 float-right">
          ...
          Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                success: function(response) {
                  ...
                  Swal.fire({
                    title: 'Student Rejected successfully!',
                    showConfirmButton: false,
                    type: 'success',
                    icon: 'success',
                    timer: 900,
      ...
      $("body").on("click",".infoBtn",function(event){
          ...
          $.ajax({
            ...
            success: function(response) {
              ...
              Swal.fire({
                title: '<strong>Student /<br>Graduate <br> info : ID '+data.id+'</strong>',
                type: 'info',
