...
<body>
  ...
  <section class="home-section">
    ...
    <div class="home-content">
      <div class="display">
        <div class="info">
          <h4>Approved Students / Graduates</h4>
        </div>
        <div class="info1">
          <a href="../controller/approved_student.php?export=excel" class="btn btn-info m-1 float-right">
...
$(document).ready(function() {
    ...
    function ShowAllUsers() {
          $.ajax({
              url: ["../controller/approved_student.php"],
              type: "POST",
              data: {
                  action: "view"
              },
